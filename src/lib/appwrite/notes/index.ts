import { databases, ID, Query, Permission, Role } from '../core/client';
import { APPWRITE_DATABASE_ID, APPWRITE_COLLECTION_ID_NOTES, APPWRITE_COLLECTION_ID_TAGS } from '../core/client';
